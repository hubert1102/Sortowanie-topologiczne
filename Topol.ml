...
(* jezeli jakis wierzcholek nie ma przypisanego stanu, to go nie odwiedzilismy,
...
(* topol l zwraca liste posortowanych topologicznie wiercholkow *)
let topol l = 
	...
	(* dfs v lv wykonuje algorytm DFS dla wiezcholka v, gdzie lv to lista nierozpatrzonych sasiadow v *)
